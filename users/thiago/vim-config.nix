...
let vim_misc_path = split(&packpath, ",")[0] . "/pack/home-manager/start/nvim/init.lua"
if filereadable(vim_misc_path)
  execute "source " . vim_misc_path
endif

" This works on NixOS 21.11pre
let vim_misc_path = split(&packpath, ",")[0] . "/pack/home-manager/start/vimplugin-nvim/init.lua"
if filereadable(vim_misc_path)
  execute "source " . vim_misc_path
endif
